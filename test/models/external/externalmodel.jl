...
@testitem "Directory management" setup = [ReadWriteUtil, ExternalModel] begin
    dirname = tempname()
    ext = ExternalModel(
        sourcedir,
        sourcefile,
...
@testitem "No Cleanup" setup = [ExternalModel] begin
    ext = ExternalModel(
        sourcedir,
        sourcefile,
        radius,
...
@testitem "Cleanup" setup = [ExternalModel] begin
    ext = ExternalModel(
        sourcedir,
        sourcefile,
        radius,
...
@testitem "Reuse model output" setup = [ReadWriteUtil, ExternalModel] begin
    workdir = tempname()
